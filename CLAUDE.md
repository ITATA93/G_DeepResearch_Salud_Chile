# CLAUDE.md — G_DeepResearch_Salud_Chile

## Identity
This is the **G_DeepResearch_Salud_Chile** satellite project under the Antigravity ecosystem.
Domain: `01_HOSPITAL_PRIVADO`

Investigacion profunda sobre regulaciones del sistema de salud chileno
